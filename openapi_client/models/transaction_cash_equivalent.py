...
class TransactionCashEquivalent(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['SWEEP_VEHICLE', 'SAVINGS', 'MONEY_MARKET_FUND', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('SWEEP_VEHICLE', 'SAVINGS', 'MONEY_MARKET_FUND', 'UNKNOWN')")
        return value
