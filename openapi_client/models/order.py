...
class Order(BaseModel):
    ...
    requested_destination: Optional[RequestedDestination] = Field(default=None, alias="requestedDestination")
    ...
    replacing_order_collection: Optional[List[Order]] = Field(default=None, alias="replacingOrderCollection")
    child_order_strategies: Optional[List[Order]] = Field(default=None, alias="childOrderStrategies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requestedDestination": obj.get("requestedDestination"),
            ...
            "replacingOrderCollection": [Order.from_dict(_item) for _item in obj["replacingOrderCollection"]] if obj.get("replacingOrderCollection") is not None else None,
            "childOrderStrategies": [Order.from_dict(_item) for _item in obj["childOrderStrategies"]] if obj.get("childOrderStrategies") is not None else None,
