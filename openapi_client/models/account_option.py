...
class AccountOption(BaseModel):
    ...
    AccountOption
    """ # noqa: E501
    option_deliverables: Optional[List[AccountAPIOptionDeliverable]] = Field(default=None, alias="optionDeliverables")
    put_call: Optional[StrictStr] = Field(default=None, alias="putCall")
    option_multiplier: Optional[StrictInt] = Field(default=None, alias="optionMultiplier")
