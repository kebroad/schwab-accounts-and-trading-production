...
class CashAccount(SecuritiesAccountBase):
    ...
    CashAccount
    """ # noqa: E501
    initial_balances: Optional[CashInitialBalance] = Field(default=None, alias="initialBalances")
    current_balances: Optional[CashBalance] = Field(default=None, alias="currentBalances")
    projected_balances: Optional[CashBalance] = Field(default=None, alias="projectedBalances")
