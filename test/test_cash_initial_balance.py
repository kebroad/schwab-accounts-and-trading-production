...
class TestCashInitialBalance(unittest.TestCase):
    """CashInitialBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CashInitialBalance:
        """Test CashInitialBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashInitialBalance`
        """
        model = CashInitialBalance()
        if include_optional:
    ...
    def testCashInitialBalance(self):
        """Test CashInitialBalance"""
