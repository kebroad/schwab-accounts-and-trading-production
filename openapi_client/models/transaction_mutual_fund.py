...
class TransactionMutualFund(BaseModel):
    ...
    """ # noqa: E501
    fund_family_name: Optional[StrictStr] = Field(default=None, alias="fundFamilyName")
    fund_family_symbol: Optional[StrictStr] = Field(default=None, alias="fundFamilySymbol")
    fund_group: Optional[StrictStr] = Field(default=None, alias="fundGroup")
    type: Optional[StrictStr] = None
    exchange_cutoff_time: Optional[datetime] = Field(default=None, alias="exchangeCutoffTime")
    purchase_cutoff_time: Optional[datetime] = Field(default=None, alias="purchaseCutoffTime")
    redemption_cutoff_time: Optional[datetime] = Field(default=None, alias="redemptionCutoffTime")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['NOT_APPLICABLE', 'OPEN_END_NON_TAXABLE', 'OPEN_END_TAXABLE', 'NO_LOAD_NON_TAXABLE', 'NO_LOAD_TAXABLE', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('NOT_APPLICABLE', 'OPEN_END_NON_TAXABLE', 'OPEN_END_TAXABLE', 'NO_LOAD_NON_TAXABLE', 'NO_LOAD_TAXABLE', 'UNKNOWN')")
        return value
