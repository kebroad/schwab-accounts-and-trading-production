...
class CollectiveInvestment(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UNIT_INVESTMENT_TRUST', 'EXCHANGE_TRADED_FUND', 'CLOSED_END_FUND', 'INDEX', 'UNITS']):
            raise ValueError("must be one of enum values ('UNIT_INVESTMENT_TRUST', 'EXCHANGE_TRADED_FUND', 'CLOSED_END_FUND', 'INDEX', 'UNITS')")
        return value
