...
class Forex(BaseModel):
    ...
    base_currency: Optional[Currency] = Field(default=None, alias="baseCurrency")
    counter_currency: Optional[Currency] = Field(default=None, alias="counterCurrency")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['STANDARD', 'NBBO', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('STANDARD', 'NBBO', 'UNKNOWN')")
        return value
