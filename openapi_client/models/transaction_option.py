...
class TransactionOption(BaseModel):
    ...
    option_deliverables: Optional[List[TransactionAPIOptionDeliverable]] = Field(default=None, alias="optionDeliverables")
    option_premium_multiplier: Optional[StrictInt] = Field(default=None, alias="optionPremiumMultiplier")
    put_call: Optional[StrictStr] = Field(default=None, alias="putCall")
    ...
    underlying_cusip: Optional[StrictStr] = Field(default=None, alias="underlyingCusip")
    ...
    def put_call_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['PUT', 'CALL', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('PUT', 'CALL', 'UNKNOWN')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['VANILLA', 'BINARY', 'BARRIER', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('VANILLA', 'BINARY', 'BARRIER', 'UNKNOWN')")
        return value
